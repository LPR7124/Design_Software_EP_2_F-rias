quest = [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'O que é Necrose?',
          ...
          'correta': 'D'}
          ,{'titulo': 'Qual destes elementos químicos é um gás nobre?',
          'nivel': 'medio',
          'opcoes': {'A': 'Hélio', 'B': 'Nitrogênio', 'C': 'Oxigênio', 'D': 'Hidrogênio'},
          'correta': 'A'},

         {'titulo': 'Em que ano ocorreu a queda do Muro de Berlim?',
          'nivel': 'dificil',
          'opcoes': {'A': '1987', 'B': '1989', 'C': '1991', 'D': '1993'},
          'correta': 'B'}
          ,{'titulo': 'Qual destas linguagens de programação foi criada por Guido van Rossum?',
          'nivel': 'medio',
          'opcoes': {'A': 'Java', 'B': 'Python', 'C': 'Ruby', 'D': 'C#'},
          'correta': 'B'},

         {'titulo': 'Qual é a unidade de medida da força no Sistema Internacional?',
          'nivel': 'dificil',
